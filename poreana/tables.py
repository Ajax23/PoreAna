...
def mc_results(link, print_con=False, sections={"pore": [], "res":[]}, len_step = []):
    ...
    coefficient will be estimated. To get the diffusion in the pore or the reservoir
    use the given option or add "pore": [], "res":[]` to a defined section dictionary.
    If you want to use certain step lengths to extrapolation the diffusion coefficient
    set these in :math:`\mathrm{len\_step}`.
    ...
    sections : dictionary, optinal
        for difusion calculation in different areas
