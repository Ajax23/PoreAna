...
class UserModelCase(unittest.TestCase):
    ...
    def test_diffusion_mc_mc(self):
        ...
        #### Test Single ####
        # Do the MC alogirthm
        pa.MC().run(model,"output/diff_test_mc.h5", nmc_eq=8000, nmc=2000, is_print=False, is_parallel=False)
    ...
    #     data = pa.utils.load_hdf("output/diff_mc_cyl_s.h5")
    #     trans_s = {}
    #     for i in data["data"]:
    #         trans_s[int(i)] = data["data"][i][:]
    #
    #     data = pa.utils.load_hdf("output/diff_mc_cyl_p.h5")
    #     trans_p = {}
    #     for i in data["data"]:
    #         trans_p[int(i)] = data["data"][i][:]
    #
    #     data = pa.utils.load_hdf("data/check_output_sample.h5")
    #     trans_check = {}
    #     for i in data["data"]:
    #         trans_check[int(i)] = data["data"][i][:]
    #
